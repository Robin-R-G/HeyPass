  ...
  return sendEmail({
    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto;">
        <div style="background: linear-gradient(135deg, #FCA311, #E09800); padding: 32px; text-align: center; border-radius: 12px 12px 0 0;">
          <h1 style="color: #000; margin: 0; font-size: 24px; font-weight: 700;">HeyPass</h1>
        </div>
        <div style="background: #14213D; padding: 32px; border-radius: 0 0 12px 12px; color: #fff;">
          <h2 style="color: #FCA311; margin-top: 0;">You're Invited!</h2>
          ...
          <div style="text-align: center; margin: 32px 0;">
            <a href="${invitationLink}" style="background: #FCA311; color: #000; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 700; font-size: 14px; display: inline-block;">Accept Invitation</a>
          </div>
  ...
  return sendEmail({
    ...
    html: `
      <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="background: #14213D; padding: 32px; border-radius: 0 0 12px 12px; color: #fff;">
          <h2 style="color: #FCA311; margin-top: 0;">Welcome aboard!</h2>
          ...
          <div style="background: rgba(255,255,255,0.05); border-radius: 8px; padding: 16px; margin: 24px 0;">
            ...
            <p style="margin: 4px 0 0; color: #fff; font-size: 14px;">Password: <strong style="color: #FCA311;">${escapeHtml(tempPassword)}</strong></p>
          </div>
          <div style="text-align: center; margin: 32px 0;">
            <a href="${loginLink}" style="background: #FCA311; color: #000; padding: 14px 32px; border-radius: 8px; text-decoration: none; font-weight: 700; font-size: 14px; display: inline-block;">Login to HeyPass</a>
          </div>

            ...
            {data.gate_breakdown.length === 0 ? (
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1rem' }}>
                {data.gate_breakdown.map((gate) => (
                  <div key={gate.gate_id} className="hp-card" style={{ borderLeft: `3px solid ${gate.is_active ? '#6366f1' : '#52525b'}` }}>
                    ...
                    <div style={{ marginBottom: '0.75rem' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.25rem' }}>
                        ...
                        <span style={{ color: '#818cf8', fontSize: '0.7rem', fontWeight: 600 }}>{gate.checkins}</span>
                      </div>
                    ...
                    <div key={h.hour} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                      <div
                        ...
                        style={{
                          ...
                          background: h.checkins > 0 ? 'linear-gradient(180deg, #6366f1, #4f46e5)' : 'transparent',
